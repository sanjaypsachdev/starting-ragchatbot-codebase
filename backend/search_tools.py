...
class CourseOutlineTool(Tool):
    """Tool for retrieving a structured course outline."""
    ...
    def get_tool_definition(self) -> Dict[str, Any]:
        return {
            ...
            "description": "Get the full outline of a course: title, course link, and the complete ordered lesson list with lesson numbers and titles",
            "input_schema": {
                "type": "object",
                "properties": {
                    "course_title": {
